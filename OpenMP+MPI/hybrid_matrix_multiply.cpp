...
int main(int argc, char **argv)
{
    ...
    if (MyRank == 0) {
        /* .......Read The Input File ...... */
        if ((fp = fopen("/home/poodar/Developments/Cpp/CLionProjects/PC_Lab4/data/mdata.inp", "r")) == nullptr)
            MatrixFileStatus = 0;
        ...
        if ((fp = fopen("/home/poodar/Developments/Cpp/CLionProjects/PC_Lab4/data/vdata.imp", "r")) == NULL) {
            VectorFileStatus = 0;
        }
